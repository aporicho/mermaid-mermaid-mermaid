...
function electronBridge(): ElectronBridge {
  return {
    ...
    getDocumentSnapshot: vi.fn(() => Promise.resolve(null)),
    openDocumentSnapshot: vi.fn(() => Promise.resolve(null)),
    syncDocumentWorkingCopy: vi.fn(() => Promise.resolve({ status: "missing" as const })),
    acquireDocumentEditLease: vi.fn(() => Promise.resolve({ status: "missing" as const })),
    resolveDocumentConflict: vi.fn(() => Promise.resolve({ status: "missing" as const })),
    ...
    listAgentInstances: vi.fn(() => Promise.resolve([])),
    setAgentInstanceForeground: vi.fn(() => Promise.resolve()),
    deleteAgentSession: vi.fn(() => Promise.resolve()),
