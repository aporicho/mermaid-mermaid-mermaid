...
export function themeToCssVariables(theme: EditorTheme): Record<string, string> {
  ...
  return {
    ...
    "--ui-overlay-background": hexToHslTriplet(ui.overlay.background),
    "--ui-overlay-opacity": `${ui.overlay.opacity}`,
    "--ui-overlay-backdrop-blur": `${ui.overlay.backdropBlur}px`,
    "--ui-window-header-opacity": `${ui.window.headerOpacity}`,
    "--ui-window-active-border-opacity": `${ui.window.activeBorderOpacity}`,
    "--ui-window-inactive-border-opacity": `${ui.window.inactiveBorderOpacity}`,
    ...
    "--ui-tree-foreground": hexToHslTriplet(ui.tree.foreground),
    ...
    "--ui-tree-focus-opacity": `${ui.tree.focusOpacity}`,
    "--ui-tree-selected-background": hexToHslTriplet(ui.tree.selectedBackground),
    "--ui-tree-selected-foreground": hexToHslTriplet(ui.tree.selectedForeground),
    "--ui-tree-row-height": `${ui.tree.rowHeight}px`,
    "--ui-tree-row-padding-start": `${ui.tree.rowPaddingStart}px`,
    "--ui-tree-row-padding-end": `${ui.tree.rowPaddingEnd}px`,
    "--ui-tree-row-padding-y": `${ui.tree.rowPaddingY}px`,
    "--ui-tree-content-gap": `${ui.tree.contentGap}px`,
    "--ui-tree-level-indent": `${ui.tree.levelIndent}px`,
    "--ui-tree-connector-rail-inset": `${ui.tree.connectorRailInset}px`,
    "--ui-tree-connector-width": `${ui.tree.connectorWidth}px`,
    "--ui-tree-icon-size": `${ui.tree.iconSize}px`,
