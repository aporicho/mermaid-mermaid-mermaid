...
export const THEME_TOKEN_GROUPS: readonly ThemeTokenGroupDefinition[] = [
  ...
  group("special-node-text-document", "specialNode", "TXT 文档", ["specialNode", "textDocument"], "konva"),
...
const TOKEN_LABELS: Record<string, string> = {
  ...
  selectedForeground: "选中文字",
  rowHeight: "行高",
  rowPaddingStart: "行首内边距",
  rowPaddingEnd: "行尾内边距",
  rowPaddingY: "行纵向内边距",
  contentGap: "图标文字间距",
  levelIndent: "层级缩进",
  connectorRailInset: "连接线轨道内缩",
