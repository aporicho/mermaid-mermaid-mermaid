  ...
  return (
    <Group>
      <CanvasStaticCacheGroup
        cacheId={`${node.id}:html-document-static`}
        cacheKey={canvasStaticCacheKey(node.label, action?.path, width, height, typography, tokens, shared, fontRevision)}
        cacheKind="html-document"
