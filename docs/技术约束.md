...
- 前端统一使用 Vite + React SPA。普通网页版只承诺 Mermaid/Markdown 项目文档编辑、查看、导入和导出；实时 AI 上下文属于桌面版或显式本地 bridge。
...
- 应用级 token 清单以 [主题令牌清单.md](主题令牌清单.md) 为准。新增主题字段、画布视觉字段、Mermaid 变量映射和对象级覆盖时，必须先归入该 token 体系。
