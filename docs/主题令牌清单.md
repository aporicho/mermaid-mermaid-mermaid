...
| `space.iconButton.size` | 主浮动图标按钮点击区域 | `EDITOR_CHROME_TOKENS.floatingButtonPx` / shadcn `icon`，当前 40px |
...
| `space.tree.rowHeight` | 左侧文件树行高 | `EDITOR_CHROME_TOKENS.treeRowHeightPx`，当前 28px |
...
| `control.iconButton.size` | 主浮动图标按钮点击区域 | `EDITOR_CHROME_CLASSES.floatingIconButton` / shadcn Button `h-10 w-10` |
