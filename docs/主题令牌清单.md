...
- `EditorTheme` 已升级为 v3，覆盖颜色、字体、尺寸、圆角、线宽、虚线、图标、画布交互、终端、ANSI 16 色、分组、连线标签、网格和诊断 token。
...
- 主题设置页已开放完整颜色字段、终端字段、ANSI 16 色和核心尺寸字段；虚线数组、字体家族和诊断阈值仍保留为 schema 级可配置，暂不在 UI 中直接编辑。
